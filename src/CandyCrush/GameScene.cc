...
GameScene::GameScene(void) : m_grid("lvl/testLvl.dat", CELL_WIDTH, CELL_HEIGHT), exitButton(SCREEN_WIDTH*0.9f, SCREEN_HEIGHT*0.9f, SCREEN_WIDTH*0.13f, SCREEN_HEIGHT*0.06f, string("Exit")){
